    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(this, &MainWindow::sig_complectGraphData, this, &MainWindow::makeGraph);
}
...
void MainWindow::on_pb_start_clicked()
{
    ...
    auto findMax = [&](QVector<double> res){
                                                ...
                                                xValue.clear();
                                                yValue.clear();
                                                QVector<double> firstSecondData = res.mid(0, FD);
                                                for (int i = 0; i < firstSecondData.size(); ++i) {
                                                    xValue.append(i);
                                                    yValue.append(firstSecondData[i]);
                                                }
                                                emit sig_complectGraphData(xValue, yValue);
